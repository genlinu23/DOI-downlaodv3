...
API_SCIHUB_URL_DEFAULT = 'https://www.sci-hub.ren'
...
API_CAPTCHA_ID_XPATHS_KEY = 'Api/CaptchaIdXPaths'
...
NETWORK_CONCURRENCY_KEY = 'Network/Concurrency'
NETWORK_CONCURRENCY_DEFAULT = 3
